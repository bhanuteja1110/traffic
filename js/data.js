(function() {
  ...
  window.SmartRouteData = {
    ...
    previousAlerts: [
      { title: 'Unusual Delay', icon: '⚠️', route: 'Home → College', delay: '+17 min', time: '8:00 AM', type: 'warning', reasons: ['Construction', 'Weather', 'Peak hours'], status: 'Action recommended' },
      { title: 'Route Normal', icon: '✓', route: 'Home → College', time: 'Yesterday', type: 'success', status: 'No action needed' }
    ]
  };
})();
